...
def generate_launch_description():
    ...
    x_pose_1 = LaunchConfiguration('x_pose', default='3.0') 
    y_pose_1 = LaunchConfiguration('y_pose', default='-3.0')
    x_pose_2 = LaunchConfiguration('x_pose', default='3.0')
    y_pose_2 = LaunchConfiguration('y_pose', default='5.0')
    ...
    map_broadcatser_cmd_1 = Node(
        ...
        arguments=[
            "--x", "3.0", "--y", "-3.0", "--z", "0.01", # world 2
            #"--x", "3.5", "--y", "-5.5", "--z", "0.01", # world ufficiale
    ...
    map_broadcatser_cmd_2 = Node(
        ...
        arguments=[
            "--x", "3.0", "--y", "5.0", "--z", "0.01", # world 2
            #"--x", "5.5", "--y", "5.5", "--z", "0.01", # world ufficiale
            "--roll", "0.0", "--pitch", "0.0", "--yaw", "3.14159",
